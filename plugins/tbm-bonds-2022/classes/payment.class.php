...
class Payment
{
  ...
  public function __construct()
  {
    ...
    $this->invoice_description = 'BONDS x Rolling Stone 2023 Charity Calendar';
  }
  ...
  public function createCustomer($payment_method, $sub_email, $sub_full_name, $buyer = [], $shipping = [])
  {
    try {
      ...
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Create Cus', $e->getError()->message);
  ...
  public function payInvoice($invoice_id)
  {
    try {
      ...
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Pay Invoice: CardException', $e->getError()->message);
      return [
      ...
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Pay Invoice: RateLimitException', $e->getError()->message);
      return [
      ...
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Pay Invoice: InvalidRequestException', $e->getError()->message);
      return [
      ...
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Pay Invoice: AuthenticationException', $e->getError()->message);
      return [
        'error' => 'Whoops, like something unexpected happened on our of things. Feel free to refresh your browser and give it another shot.',
        'invoice' => $invoice,
        'stripe_error' => $e->getError()->message
      ...
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Pay Invoice: ApiConnectionException', $e->getError()->message);
      return [
      ...
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Pay Invoice: ApiErrorException', $e->getError()->message);
      return [
      ...
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Pay Invoice: Exception', $e->getError()->message);
      return [
        'error' => 'Whoops, like something unexpected happened on our side of things. Please contact subscribe@thebrag.media with the details you submitted.',
        'invoice' => $invoice,
        'stripe_error' => $e->getError()->message
  ...
  public function cancelSubscription($sub_id)
  {
    try {
      ...
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe CancelSubscription: CardException', $e->getError()->message);
      return [
        'error' => 'It looks like your card has been declined. Make sure all your details are correct, your card is valid, and give it another shot.',
        'stripe_error' => $e->getError()->message
      ];
      ...
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe CancelSubscription: RateLimitException', $e->getError()->message);
      return [
        'error' => 'Whoops, it looks like something unexpected happened on our of things. Feel free to refresh your browser and give it another shot.',
        'stripe_error' => $e->getError()->message
      ];
      ...
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe CancelSubscription: InvalidRequestException', $e->getError()->message);
      return [
        'error' => 'Whoops, like something unexpected happened on our of things. Feel free to refresh your browser and give it another shot.',
        'stripe_error' => $e->getError()->message
      ];
      ...
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe CancelSubscription: AuthenticationException', $e->getError()->message);
      return [
        'error' => 'Whoops, like something unexpected happened on our of things. Feel free to refresh your browser and give it another shot.',
        'stripe_error' => $e->getError()->message
      ];
      ...
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe CancelSubscription: ApiConnectionException', $e->getError()->message);
      return [
        'error' => 'Whoops, it seems we had a bit of trouble getting in contact with the payment service. Feel free to refresh your browser and give it another shot!',
        'stripe_error' => $e->getError()->message
      ];
      ...
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe CancelSubscription: ApiErrorException', $e->getError()->message);
      return [
        'error' => 'Whoops, like something unexpected happened on our side of things. Please contact subscribe@thebrag.media with the details you submitted.',
        'stripe_error' => $e->getError()->message
      ];
      ...
      error_log('--Stripe Error | CancelSubscription | Exception: ' . $e->getError()->message);
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe CancelSubscription: Exception', $e->getError()->message);
      return [
        'error' => 'Whoops, like something unexpected happened on our side of things. Please contact subscribe@thebrag.media with the details you submitted.',
        'stripe_error' => $e->getError()->message
      ];
  ...
  public function createInvoice($subtotal, $shipping_cost, $quantity, $payment_method = NULL, $sub_email, $sub_full_name, $buyer = [], $shipping = [], $customer_id = NULL, $collection_method = 'charge_automatically', $description = '')
  {
    try {
      $customer = null;
      ...
      error_log('--Stripe Error | Invoice | CardException : ' . $e->getError()->message);
      // wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Create Invoice: CardException', $e->getError()->message);
      return [
        'error' => 'It looks like your card has been declined. Make sure all your details are correct, your card is valid, and give it another shot.',
        'customer' => $customer,
        'invoice' => $invoice,
      ...
      error_log('--Stripe Error | Invoice | RateLimitException: ' . $e->getError()->message);
      // wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Create Invoice: RateLimitException', $e->getError()->message);
      return [
        'error' => 'Whoops, it looks like something unexpected happened on our of things. Feel free to refresh your browser and give it another shot.',
        'customer' => $customer,
        'invoice' => $invoice,
      ...
      error_log('--Stripe Error | Invoice | InvalidRequestException: ' . $e->getError()->message);
      // wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Create Invoice: InvalidRequestException', $e->getError()->message);
      return [
        'error' => 'Whoops, like something unexpected happened on our of things. Feel free to refresh your browser and give it another shot.',
        'customer' => $customer,
        'invoice' => $invoice,
      ...
      error_log('--Stripe Error | Invoice | AuthenticationException: ' . $e->getError()->message);
      // wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Create Invoice: AuthenticationException', $e->getError()->message);
      return [
        'error' => 'Whoops, like something unexpected happened on our of things. Feel free to refresh your browser and give it another shot.',
        'customer' => $customer,
        'invoice' => $invoice,
      ...
      error_log('--Stripe Error | Invoice | ApiConnectionException: ' . $e->getError()->message);
      // wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Create Invoice: ApiConnectionException', $e->getError()->message);
      return [
        'error' => 'Whoops, it seems we had a bit of trouble getting in contact with the payment service. Feel free to refresh your browser and give it another shot!',
        'customer' => $customer,
        'invoice' => $invoice,
      ...
      error_log('--Stripe Error | Invoice | ApiErrorException: ' . $e->getError()->message);
      // wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Create Invoice: ApiErrorException', $e->getError()->message);
      return [
        'error' => 'Whoops, like something unexpected happened on our side of things. Please contact subscribe@thebrag.media with the details you submitted.',
        'customer' => $customer,
        'invoice' => $invoice,
      ...
      error_log('--Stripe Error | Invoice | Exception: ' . $e->getError()->message);
      // wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Create Invoice: Exception', $e->getError()->message);
      return [
        'error' => 'Whoops, like something unexpected happened on our side of things. Please contact subscribe@thebrag.media with the details you submitted.',
        'customer' => $customer,
        'invoice' => $invoice,
  ...
  public function updateCustomer($subscriber)
  {
    try {
      ...
      error_log('--Stripe Error | Customer | CardException : ' . $e->getError()->message);
      wp_mail('sachin.patel@thebrag.media', 'RS Mag Error: Stripe Update Cus', $e->getError()->message);
      return ['error' => 'It looks like your card has been declined. Make sure all your details are correct, your card is valid, and give it another shot.'];
      wp_die();
    } catch (\Stripe\Exception\RateLimitException $e) {
      error_log('--Stripe Error | Customer | RateLimitException: ' . $e->getError()->message);
