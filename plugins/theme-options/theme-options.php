    ...
    if ( $query->have_posts()) :
        while ($query->have_posts()) :
            ...
            $articles_arr[] = [
                ...
                'title' => get_the_title(),
                'category' => $categories[0]->cat_name,
                'brand_logo' => 'https://images-r2.thebrag.com/common/brands/au.rollingstone.png',
    ...
    if ($news_query->have_posts()) :
        ...
        while ($news_query->have_posts()) :
            ...
            $articles_arr['articles'][] = [
                ...
                'title' => get_the_title(),
                'category' => $category,
                'brand_logo' => 'https://images-r2.thebrag.com/common/brands/Rolling-Stone-Australia-light.png',
                'brand_link' => 'https://au.rollingstone.com',
                'excerpt' => $excerpt,
                'link' => get_the_permalink(),
            ];
