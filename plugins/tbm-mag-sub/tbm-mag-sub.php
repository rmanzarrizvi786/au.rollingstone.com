...
class TBMMagSub {
    ...
    public function __construct() {
        ...
        */
        ...
        add_action('wp_ajax_nopriv_process_upcoming_renewals', array($this, 'ajax_process_upcoming_renewals'));
...
(
    ...
    public function _rest_api_init()
    {
        ...
        register_rest_route($this->plugin_name . '/v1', '/get_buy_options', array(
            'methods' => 'GET',
