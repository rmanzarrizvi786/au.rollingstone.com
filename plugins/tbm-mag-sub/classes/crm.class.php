...
class CRM
{
  ...
  public function __construct()
  {
    ...
    $this->is_sandbox = isset($_ENV) && isset($_ENV['ENVIRONMENT']) && 'sandbox' == $_ENV['ENVIRONMENT']; // in_array($_SERVER['REMOTE_ADDR'], ['127.0.0.1', '::1']); //false;
    ...
    $this->listview_active_emails_only = $this->is_sandbox ? '00B9D000002zZmLUAU' : '00B9o000000UOC5EAO';
