...
?>
  ...
  public function amp_post_template_metadata($metadata, $post)
  {
    ...
    $metadata['publisher']['logo'] = array(
      '@type' => 'ImageObject',
      'url' => get_template_directory_uri() . '/images/edm/RS-AU_LOGO-RED.png',
      'height' => 85,
      'width' => 439,
    );
  ...
  public function amp_post_template_css($amp_template)
  {
    ...
    a, a:visited, a:hover, a:active, a:focus { color: #d32531; }
    .amp-wp-header {
    padding: 0;
    background: #ffffff;
    ...
    .amp-wp-header a {
    background-image: url( '<?php echo get_template_directory_uri(); ?>/images/edm/RS-AU_LOGO-RED.png' );
    ...
    .amp-wp-title { color: #d32531; font-weight: 500 }
