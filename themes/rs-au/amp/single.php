...
<head>
	...
	if ($primary_category_id) {
		...
		$url_path_array = explode('/', parse_url(get_the_permalink())['path']);
		if ($url_path_array && $url_path_array[1])
			$primary_category = $url_path_array[1];
	}

	// $primary_category_name = yoast_get_primary_term('category', get_the_ID());
	?>
...
<body class="<?php echo esc_attr($this->get('body_class')); ?>">
	...
	<article class="amp-wp-article" style="margin-top: 35px; margin-bottom: 15px;">
		<div class="amp-ad" style="text-align: center; margin: auto;">
			<?php echo ThemeSetup::render_ads('header'); ?>
		</div>
		...
		<div class="amp-wp-article-content">
			...
			?>
					...
					<div amp-access="access" amp-access-hide class="premium-content">
						...
						?>
								<div class="amp-ad" style="text-align: center; margin: auto;">
									<?php echo ThemeSetup::render_ads('mrec_1'); ?>
								</div>
						<?php
							endif;
							echo $content[$i] . "</p>";
						...
						<div class="amp-ad" style="text-align: center; margin: auto;">
							<?php echo ThemeSetup::render_ads('mrec_2'); ?>
						</div>

						<?php if (!$hasApester) : ?>
							<p>&nbsp;</p>
							<amp-apester-media height="390" data-apester-channel-token="5decf5e2b7735f2b3529b693"> </amp-apester-media>
							<p>&nbsp;</p>
						<?php endif; ?>

						<div class="amp-ad" style="text-align: center; margin: auto;">
							<?php echo ThemeSetup::render_ads('sticky_footer'); ?>
						</div>
					</div>
					<?php
				}
