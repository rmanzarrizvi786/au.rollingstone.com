...
class PMC_Top_Videos {
	...
	public function register_post_type() {
		register_post_type(
			self::POST_TYPE_NAME, array(
				...
				'public'               => true,
				'supports'             => array( 'title', 'author', 'comments', 'editor', 'thumbnail', 'excerpt' ),
				'has_archive'          => 'videos',
	...
	public function top_video_information_meta_box( $post ) {
		...
		echo \PMC::render_template( // WPCS: XSS ok.
			...
			get_template_directory() . '/pmc-plugins/pmc-top-videos-v2/templates/top-videos-information-metabox-v2.php',
			array(
	...
	function output_recent_top_video_slider( $force_recache = false ) {
		...
		$videos = $PMC_Top_Videos->get_posts(
			array(
				'posts_per_page'         => 12,
		...
		if ( $videos->have_posts() ) {
			...
			while ( $videos->have_posts() ) {
				...
				echo \PMC::render_template( // WPCS: XSS ok.
					...
					get_template_directory() . '/pmc-plugins/pmc-top-videos-v2/templates/top-videos-slider.php',
					array(
						'videos'          => $videos,
						'video_duration'  => $video_duration,
	...
	public function load_frontend_assets() {
		...
		wp_enqueue_style( 'pmc-top-videos-frontend-css', get_template_directory_uri() . '/pmc-plugins//pmc-top-videos-v2/css/frontend.css' );
	}
...
function pmc_core_recent_video_slider() {
	$instance = new PMC_Top_Videos(); // PMC_Top_Videos::get_instance();
