		...
		<tr>
			<th scope="row">
				<label for="pmc_top_video_source">
					<?php esc_html_e( 'Video URL', 'pmc-top-videos-v2' ); ?>
				</label>
			</th>
			<td>
				<input
				...
				<p class="description">
					...
					<a href="<?php echo esc_url( 'https://wordpress.org/support/article/embeds/#okay-so-what-sites-can-i-embed-from' ); ?>" title="<?php esc_attr_e( 'WordPress oEmbed', 'pmc-top-videos-v2' ); ?>" target="_blank"><?php esc_html_e( 'oEmbed', 'pmc-top-videos-v2' ); ?></a>

					<?php esc_html_e( '(e.g. YouTube, DailyMotion, etc.)', 'pmc-top-videos-v2' ); ?>
				</p>
			</td>
		</tr>
		<!-- <tr>
