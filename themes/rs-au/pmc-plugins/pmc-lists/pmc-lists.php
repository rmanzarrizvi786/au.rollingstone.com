...
define( 'PMC_LISTS_URL', get_template_directory_uri() . '/pmc-plugins/pmc-lists/' );


$list_opt = 'no'; // PMC_Cheezcap::get_instance()->get_option( 'pmc_gallery_list_enabled' );
