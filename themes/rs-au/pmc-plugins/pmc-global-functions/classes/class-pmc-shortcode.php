...
class PMC_Shortcode {
	...
	public static function load() {
		add_shortcode( 'pmc_twitter_followme', array( 'PMC_Shortcode', 'twitter_followme' ) );
		add_shortcode( 'pmc_facebook_likebox' , array( 'PMC_Shortcode', 'facebook_like_box' ) );
		add_shortcode( 'pmc-ndn', array( 'PMC_Shortcode', 'pmc_ndn') );
		add_shortcode( 'pmc_onescreen', array( __CLASS__, 'pmc_onescreen') );
		add_shortcode( 'pmc_qzzr', array( 'PMC_Shortcode', 'pmc_qzrr' ) );
		add_shortcode( 'pmc_local_measure', array( 'PMC_Shortcode', 'pmc_local_measure') );
		add_shortcode( 'pmc_boombox',  array( 'PMC_Shortcode', 'pmc_create_boombox_embed_script' ) );
	}
