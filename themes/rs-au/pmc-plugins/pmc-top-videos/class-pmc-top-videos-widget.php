						...
						<li class="top-video col-xs-3 col-md-3">
							<a href="<?php echo esc_url( get_permalink( $post->ID ) ); ?>" class="thumb">
								...
								<div class="video-text-wrap">
									...
									<div class="video-caption-widget"><?php
									// echo wp_kses_post( PMC_Top_Videos::get_instance()->get_meta_data( $post->ID, "caption" ) );
									$PMC_Top_Videos = new PMC_Top_Videos();
									echo wp_kses_post( $PMC_Top_Videos->get_meta_data( $post->ID, "caption" ) );
									?></div>
								</div>
							</a>
						</li><?php
