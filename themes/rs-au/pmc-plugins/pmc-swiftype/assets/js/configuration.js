...
if ( SwiftypeConfigs.autocomplete.tags.include ) {
	 ...
	 */
	jQuery( '#swiftype-search-widget, #swiftype-search-result' ).on( 'click', '.ac_tag', function( e ) {
		e.preventDefault();
		e.stopPropagation();
