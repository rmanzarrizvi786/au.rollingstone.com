...
<div class="pmc-adm-boomerang-pub-div <?php echo esc_attr( $ad['css-class'] ); ?>">
	<div id="<?php echo esc_attr( $ad['div-id'] ); ?>"
		class="<?php printf( 'adw-%s adh-%s', esc_attr( $ad['width'] ), esc_attr( $ad['height'] ) ); ?>" data-is-adhesion-ad="<?php echo $is_adhesion_ad_unit ? true : false; ?>">
