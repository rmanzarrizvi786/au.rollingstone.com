...
require_once( PMC_ADM_DIR . '/providers/pmc-default.php' );
...
function pmc_adm_render_shortcode( $atts ) {
	...
	if ( ! empty( $ads_location ) && ! empty( $ads_title ) ) {
		return pmc_adm_render_ads( $ads_location, sanitize_text_field( $ads_title, false ) );
	}
}
