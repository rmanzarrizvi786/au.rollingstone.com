<?php
    ...
    */
    ...
    $submissions_active = time() < strtotime('2024-01-01');
...
if (have_posts()) : while (have_posts()) : the_post(); if (!post_password_required($post)) : ?>
    <div class="l-page__content">
        <div class="slideshow-wrap" id="slideshow-wrap1">
            <div class="slideshow js-slideshow" id="js-slideshow1" style="display: none;">
            <?php for ($i = 0; $i < 5; $i++) : ?>
            <div class="slide">
                <img src="<?php echo RS_THEME_URL ?>/images/scu-scholarship-2021/scroll-1.jpg" style="width: auto !important; height: 100% !important; max-width: none !important;" />
            </div>
            <?php endfor; ?>
        </div>
    </div>
    ...
    <div class="l-section l-section--no-separator" style="margin: 2rem auto; max-width: 50rem;">
        <div class="c-content c-content--no-sidebar t-copy" style="width: 100%;">
            <div class="scu-scholarship-wrap">
                ...
                <p>
                    In partnership with Southern Cross University, Rolling Stone Australia is proud to announce the third Rolling Stone Music Scholarship, which will be awarded to hard-working, passionate individual looking to study a <a href="https://www.scu.edu.au/study-at-scu/music-and-creative-arts/contemporary-music/?utm_source=rolling_stone&utm_medium=display&utm_campaign=music_scholarship_2023&utm_content=micro_site&utm_term=null" target="_blank">Bachelor of Contemporary Music</a>.
                </p>
                ...
                <p>
                    By learning in kick-arse studios, performance spaces, keyboard labs, music production labs and rehearsal studios, Southern Cross music students are equipped for the perfect start in a career in music.
                </p>
                <p>
                    Applications open on July 3 and close on September 28. From there, top responses will be asked to audition and meet the entry requirements of the degree. To apply, submit your application via the form below.
                </p>
            ...
            <div style="margin-top: 2rem; text-align: center;">
                <h3>Hear from a past scholarship recipient:</h3>
                <div style="display: inline-block; border: 4px solid #555; line-height: 1; padding: .5rem; background-color: #ccc;">
        ...
        <!-- <div><a href="#" target="_blank" style="text-align: center; margin: 2rem auto; font-weight: 600; box-shadow: 0 0 18px #aaa; border-radius: 1rem; padding: .5rem 1rem; background: #000; color: #fff; display: block;"></a></div> -->
