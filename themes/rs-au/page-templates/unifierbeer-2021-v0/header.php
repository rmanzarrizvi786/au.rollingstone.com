...
<head>
  ...
  <style>
    ...
    @font-face {
      ...
      src: url("<?php echo RS_THEME_URL; ?>/page-templates/unifierbeer-2021/fonts/FatFrank-Regular.otf") format("opentype");
      font-weight: normal;
      font-style: normal;
      font-display: swap;
    }
    ...
    @font-face {
      ...
      src: url("<?php echo RS_THEME_URL; ?>/page-templates/unifierbeer-2021/fonts/PintassilgoPrints - Ars Nova.otf") format("opentype");
      font-weight: normal;
      font-style: normal;
      font-display: swap;
    }
