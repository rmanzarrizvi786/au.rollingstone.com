...
/**
 * Template Name: Rolling Stone Awards 2022 (Info)
 */
...
get_header('rsawards-custom-menu');
?>
          ...
          <div class="col-12">
            <div class="d-flex flex-column flex-md-row align-items-stretch">
              <div class="col-12">
                ...
                switch ($show) {
                  case 'news':
                    get_template_part('page-templates/rs-awards/2022/news');
                    break;
                  case 'categories':
                    get_template_part('page-templates/rs-awards/2022/categories', NULL, ['award_categories' => $award_categories, 'noms_open' => $noms_open, 'noms_open_at' => $noms_open_at, 'context' => 'info']);
                    break;
                  case 'faq':
                    get_template_part('page-templates/rs-awards/2022/faq');
                    break;
                  case 'info':
                    get_template_part('page-templates/rs-awards/2022/info');
                    break;
                  case 'judges':
                    get_template_part('page-templates/rs-awards/2022/judges');
                    break;
                  case 'venue-details':
                    get_template_part('page-templates/rs-awards/2022/venue-details');
                    break;
                  case 'sponsors':
                    get_template_part('page-templates/rs-awards/2022/sponsors');
                    break;
                  default:
                    get_template_part('page-templates/rs-awards/2022/news');
                    break;
