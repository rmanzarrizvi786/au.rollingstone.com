...
$remote_url = 'http://api.ipstack.com/' . $_SERVER['REMOTE_ADDR'] . '?access_key=7e21f9bc68d13cd5175cbe9dc5e5b292';
$country_code = json_decode(wp_remote_retrieve_body(wp_remote_request($remote_url)))->country_code;
...
$noms_open_at = '2022-05-07 12:00:00';
$noms_open = true;
$noms_closed = false;
...
?>
			<div id="content-wrap">
				...
				<div class="container rsa-header" style="background-color: #fff;">
					<img src="<?php echo get_template_directory_uri(); ?>/images/rsa2022/nz/PHRSNZAwardsNomsLanding_hero.jpg">
				</div>
							...
							?>
								...
								?>
									<div style="font-family: 'Roboto', sans-serif;">
										...
										<p>As a Rolling Stone Australia/New Zealand subscriber, you are part of an elite club that pays for music journalism. This means music really matters to you, and it is for that reason you are a vital part of the 2022 Panhead Rolling Stone New Zealand Awards.</p>
										...
										<p>From today until May 24, Rolling Stone Australia/New Zealand subscribers can cast their nomination for their favourite New Zealand artist.</p>
										<p>From there, the most nominated artists will progress to a final round where subscribers will vote for the final winner. This second round will take place on 28th May 2022.</p>
										<p>This award is judged solely by our readers, the subscribers who are the life blood of music journalism. As such if you would like to nominate in the first round or vote in the second, make sure that you're subscribed to Rolling Stone Australia/New Zealand Magazine.</p>
										<p>Any New Zealand artist who has released a song, album or EP within the eligibility period of 1st April 2021 - 31st March 2022 is eligible, and can be nominated below.</p>
										<p>You will decide the winner of the prestigious and most coveted Rolling Stone New Zealand Readers Award.</p>
									</div>
									<div class="flex-wrap">
										<?php
										if ('nz' != strtolower($country_code) && !$is_sandbox && !current_user_can('administrator')) :
										?>
											<div class="awardnoms card">
												<div class="card-body bg-dark text-white" style="text-align: center; padding: 0; font-weight: bold; background: #d32531 !important;">
													<p style="margin-top: 1rem;">Submitting nominations are open to New Zealand residents only</p>
												</div>
											</div>
											<?php
										else :
											$rs_nominated = get_user_meta($current_user->ID, 'rsawards_nominated_nz_2022', true);
											...
											?>
												...
												<div id="awardnoms1" class="awardnoms card" aria-labelledby="awardnoms-heading1" data-id="1" style="">
													<div class="card-body bg-dark text-white">
														<p>
															For your nomination to count the artist <strong>must be a New Zealand resident or citizen</strong> and must have released an Album, EP or single between <strong>1st April 2021 - 31st March 2022</strong>.
														</p>
									...
									<div class="d-md-flex align-items-center">
										...
										<div>
											<h4 style="font-size: 130%; line-height: 1.7; text-align: center; margin: auto 1rem;">
												...
												<br><br>
												If you currently don't have a Rolling Stone Australia Magazine subscription, you can subscribe <a href="https://au.rollingstone.com/subscribe-magazine/" target="_blank" style="color: #d32531;">here</a> and go in the running to win exclusive tickets to the awards for you and 3 of your mates.
											</h4>
											<br>
		...
		jQuery(document).ready(function($) {
			jQuery(document).ready(function($) {
				$('#voting-form').on('submit', function(eve) {
					...
					formData.append('action', 'nominate_readers_award_nz_2022');
