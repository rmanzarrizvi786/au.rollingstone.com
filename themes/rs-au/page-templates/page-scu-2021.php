...
/**
 * Template Name: SCU Scholarship (2021)
 */
...
wp_enqueue_script('scu-scholarship-2020', get_template_directory_uri() . '/page-templates/scu-scholarship-2020/js/scripts-2021.js', ['jquery'], time(), true);
?>
<?php
        ...
        <div class="l-section l-section--no-separator" style="margin: 2rem auto; max-width: 50rem;">
          <div class="c-content c-content--no-sidebar t-copy" style="width: 100%;">
            ...
            <div class="scu-scholarship-wrap">
              ...
              <p>Applications open on October 15, and close on December 13, 2021. From there, top responses will be asked to audition. To apply, submit your application via the form below.</p>
