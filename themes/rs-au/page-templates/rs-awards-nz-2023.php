...
/**
 * Template Name: Rolling Stone Awards NZ 2023 (Info)
 */

define('ICONS_URL', get_template_directory_uri() . '/images/');

$award_categories = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}rsawards_categories_2023_nz WHERE status = '1'");
$action = isset($_GET['a']) && in_array(trim($_GET['a']), ['add', 'edit', 'ty']) ? trim($_GET['a']) : NULL;

get_header('rsawards-custom-menu-2023-nz');
?>
            ...
            <div class="d-flex flex-column flex-md-row align-items-stretch">
              <div class="col-12">
                ...
                switch ($show) {
                  ...
                  //   break;
                  case 'info':
                    get_template_part('page-templates/rs-awards/2023/nz/info');
                    break;
                  // case 'judges':
