                ...
                <?php else : ?>
                    ...
                    <div id="content-wrap2">
                        ...
                        <section class="upcoming-events px-2 px-md-4 py-2 py-md-3">
                            <div class="content-wrap">
                                <h2 class="d-flex justify-content-center" style="margin-bottom: 1rem">
                                ...
                                <div class="d-flex flex-wrap flex-column flex-md-row align-items-stretch my-3">
                                        ...
                                        <div class="mt-3 mt-md-0 d-flex flex-column align-items-stretch mr-0 mr-md-2">
                                            <div class="event-wrap event-01">
                                                ...
                                                <div class="info">
                                                    ...
                                                    <a href="https://welcomesessionslive-23.jimbeampromotions.com.au/sydney.php" target="_blank" class="mt-3 btn btn-tickets">CLOSED</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 d-flex align-items-stretch">
                                        <div class="mt-4 mt-md-0 d-flex flex-column align-items-stretch ml-0 ml-md-2">
                                            <div class="event-wrap event-02">
                                                <div class="event">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/images/jim-beam-2023/DRAPHT.jpg">
                                                    <div class="city" style="color: #fff; text-shadow: 1px 1px 10px #000">
                                                        PERTH
                                                    </div>
                                                </div>
                                                <div class="info col-12 col-md-6">
                                                    <div class="text-kuunari-bold" style="font-size: 200%; line-height: 200%;">DRAPHT</div>
                                                    <p>Saturday, March 4th</p>
                                                    <p>The Aviary, Perth</p>
                                                    <a href="https://welcomesessionslive-23.jimbeampromotions.com.au/perth.php" target="_blank" class="mt-3 btn btn-tickets">CLOSED</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 d-flex align-items-stretch">
                                        <div class="mt-4 mt-md-0 d-flex flex-column align-items-stretch ml-0 ml-md-2">
                                            <div class="event-wrap event-02">
                                                <div class="event">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/images/jim-beam-2023/bagraiders.jpg">
                                                    <div class="city" style="color: #fff; text-shadow: 1px 1px 10px #000">
                                                        ADELAIDE
                                                    </div>
                                                </div>
                                                <div class="info col-12 col-md-6">
                                                    <div class="text-kuunari-bold" style="font-size: 200%; line-height: 200%;">BAG RAIDERS (DJ SET)</div>
                                                    <p>Saturday, March 25th</p>
                                                    <p>Mosely Bar & Kitchen, Adelaide</p>
                                                    <a href="https://welcomesessionslive-23.jimbeampromotions.com.au/adelaide.php" target="_blank" class="mt-3 btn btn-tickets">CLOSED</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex flex-wrap flex-column flex-md-row align-items-stretch my-3">
                                    ...
                                    <div class="col-12 col-md-4 d-flex align-items-stretch">
                                        <div class="mt-3 mt-md-0 d-flex flex-column align-items-stretch mr-0 mr-md-2">
                                            <div class="event-wrap event-01">
                                                <div class="event">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/images/jim-beam-2023/wafia.jpg">
                                                    <div class="city" style="color: #fff; text-shadow: 1px 1px 10px #000">
                                                        GOLD COAST
                                                    </div>
                                                </div>
                                                <div class="info">
                                                    <div class="text-kuunari-bold" style="font-size: 200%; line-height: 200%;">WAFIA</div>
                                                    <p>Saturday, April 8th</p>
                                                    <p>The Lawn at Garden Kitchen & Bar, Gold Coast</p>
                                                    <a href="https://welcomesessionslive-23.jimbeampromotions.com.au/gc.php" target="_blank" class="mt-3 btn btn-tickets">CLOSED</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-4 d-flex align-items-stretch">
                                        <div class="mt-4 mt-md-0 d-flex flex-column align-items-stretch ml-0 ml-md-2">
                                            <div class="event-wrap event-02">
                                                <div class="event">
                                                    <img src="<?php echo get_template_directory_uri(); ?>/images/jim-beam-2023/junglegiants.jpg">
                                                    <div class="city" style="color: #fff; text-shadow: 1px 1px 10px #000">
                                                        MELBOURNE
                                                    </div>
                                                </div>
                    ...
                    <section class="latest-news px-2 px-md-4 py-2 py-md-3">
                        <div class="content-wrap">
                                ...
                                <div class="col-12">
                                    <div class="mb-4 mb-md-2 mr-0 mr-md-1">
                                        <h2 class="d-flex justify-content-center" style="margin-bottom: 1rem">
                                            ...
                                            &nbsp;
                                            <span class="text-kuunari-condensed" style="font-size: 300%; line-height: 100%;">2023</span>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex flex-column my-4">
                                <div style="width: 1px; height: 70px; background-color: #ccc;"></div>
                                <h3 class="mt-1">The Jungle Giants in Melbourne Recap</h3>
                                <div class="content-wrap my-2 d-flex">
                                    <div class="text-center" style="width: 890px; max-width: 100%;font-family: Graphik-Medium, sans-serif;">
                                        <div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;"><iframe style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden" frameborder="0" type="text/html" src="https://www.dailymotion.com/embed/video/x8m2lak" width="100%" height="100%"   allow="autoplay" allowfullscreen></iframe></div>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex flex-column my-4">
                                ...
                                <div class="content-wrap my-2 d-flex">
                                    <div class="text-center" style="width: 890px; max-width: 100%;font-family: Graphik-Medium, sans-serif;">
                                        <div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;"><iframe style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden" frameborder="0" type="text/html" src="https://www.dailymotion.com/embed/video/x8kxtct" width="100%" height="100%"   allow="autoplay" allowfullscreen></iframe></div>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex flex-column my-4">
                                <div style="width: 1px; height: 70px; background-color: #ccc;"></div>
                                <h3 class="mt-1">Bag Raiders (DJ Set) in Adelaide Recap</h3>
                                <div class="content-wrap my-2 d-flex">
                                    <div class="text-center" style="width: 890px; max-width: 100%;font-family: Graphik-Medium, sans-serif;">
                                        <div>
                                            <div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;"><iframe style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden" frameborder="0" type="text/html" src="https://www.dailymotion.com/embed/video/x8ka3jy" width="100%" height="100%" allowfullscreen></iframe></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex flex-column my-4">
                                <div style="width: 1px; height: 70px; background-color: #ccc;"></div>
                                <h3 class="mt-1">Drapht in Perth Recap</h3>
                                <div class="content-wrap my-2 d-flex">
                                    <div class="text-center" style="width: 890px; max-width: 100%;font-family: Graphik-Medium, sans-serif;">
                                        <div>
                                            <div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;"> <iframe style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden" frameborder="0" type="text/html" src="https://www.dailymotion.com/embed/video/x8j56na" width="100%" height="100%" allowfullscreen title="Dailymotion Video Player" > </iframe> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex flex-column my-4">
                                <div style="width: 1px; height: 70px; background-color: #ccc;"></div>
                                <h3 class="mt-1">Lime Cordiale (DJ Set) in Sydney Recap</h3>
                                <div class="content-wrap my-2 d-flex">
                                    <div class="text-center" style="width: 890px; max-width: 100%;font-family: Graphik-Medium, sans-serif;">
                                        <div>
                                            <div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;"> <iframe style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden" frameborder="0" type="text/html" src="https://www.dailymotion.com/embed/video/k3JwMbRdF0p7WKyRz0M" width="100%" height="100%" allowfullscreen title="Dailymotion Video Player" > </iframe> </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex flex-wrap flex-column flex-md-row align-items-stretch my-3">
                                <div class="col-12">
                                    <div class="mb-4 mb-md-2 mr-0 mr-md-1">
                                        ...
                                        <h2 class="d-flex justify-content-center" style="margin-bottom: 1rem">
                                            <span class="text-kuunari-bold" style="font-size: 175%; line-height: 100%; text-decoration: underline;">EVENT</span>
                                            &nbsp;
                                            <span class="text-kuunari-condensed" style="font-size: 300%; line-height: 100%;">PHOTOS</span>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="event-wrap event-01">
                                            <div class="event event-sydney">
                                                <a href="https://au.rollingstone.com/music/music-pictures/gallery-jim-beam-welcome-sessions-with-the-jungle-giants-47397/" target="_blank" arget="_blank">
                                                    <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2023/05/2.JungleGiants_Performance57.jpg?resize=1400,700&w=1400">
                                                </a>
                                            </div>
                                            <div class="info">
                                        ...
                                        <div class="event-wrap event-01">
                                            <div class="event event-sydney">
                                                <a href="https://au.rollingstone.com/music/music-pictures/gallery-jim-beam-welcome-sessions-with-wafia-46833/" target="_blank" arget="_blank">
                                                    <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2023/04/2.Wafia_Performance45.jpg?resize=1400,700&w=1400">
                                                </a>
                                            </div>
                                            <div class="info">
                                                ...
                                                <p>Saturday, April 8th</p>
                                                <p>The Lawn at Garden Kitchen & Bar, Gold Coast</p>
                                                <a href="https://au.rollingstone.com/music/music-pictures/gallery-jim-beam-welcome-sessions-with-wafia-46833/" target="_blank" class="mt-3 btn btn-tickets" target="_blank" class="mt-3 btn btn-tickets">View Gallery</a>
                                            </div>
                                        </div>
                                    </div>                                    
                                    <div class="ol col-md-4 mb-4 pr-0 pr-md-2 d-flex align-items-stretch">
                                        <div class="event-wrap event-01">
                                            <div class="event event-sydney">
                                                <a href="https://au.rollingstone.com/music/music-pictures/gallery-jim-beam-welcome-sessions-with-bag-raiders-dj-set-46783/" target="_blank" arget="_blank">
                                                    <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2023/04/2.BagRaiders_Performance14.jpg?resize=1400,700&w=1400">
                                                </a>
                                            </div>
                                            <div class="info">
                                                <div class="text-kuunari-bold" style="font-size: 150%; line-height: 100%;">Jim Beam Welcome Sessions with<br /> Bag Raiders (DJ Set)</div>
                                                <p>Saturday, March 25th</p>
                                                <p>Mosely Bar & Kitchen, Adelaide</p>
                                                <a href="https://au.rollingstone.com/music/music-pictures/gallery-jim-beam-welcome-sessions-with-bag-raiders-dj-set-46783/" target="_blank" class="mt-3 btn btn-tickets" target="_blank" class="mt-3 btn btn-tickets">View Gallery</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="ol col-md-4 mb-4 pr-0 pr-md-2 d-flex align-items-stretch">
                                        <div class="event-wrap event-01">
                                            <div class="event event-sydney">
                                                <a href="https://au.rollingstone.com/music/music-pictures/gallery-jim-beam-welcome-sessions-with-drapht-45958/" target="_blank" arget="_blank">
                                                    <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2023/03/2.Drapht_Performance15_2.jpg?resize=1400,700&w=1400">
                                                </a>
                                            </div>
                                            <div class="info">
                                                <div class="text-kuunari-bold" style="font-size: 150%; line-height: 100%;">Jim Beam Welcome Sessions with<br /> Drapht</div>
                                                <p>Saturday, March 4th</p>
                                                <p>The Aviary, Perth</p>
                                                <a href="https://au.rollingstone.com/music/music-pictures/gallery-jim-beam-welcome-sessions-with-drapht-45958/" target="_blank" class="mt-3 btn btn-tickets" target="_blank" class="mt-3 btn btn-tickets">View Gallery</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="event-wrap event-01">
                                            <div class="event event-sydney">
                                                <a href="https://au.rollingstone.com/music/music-pictures/gallery-jim-beam-welcome-sessions-with-lime-cordiale-dj-set-45616/" target="_blank" arget="_blank">
                                                    <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2023/03/2.LimeCordiale_Performance10.jpg?resize=1400,700&w=1400">
                                                </a>
                                            </div>
                                            <div class="info">
                                                <div class="text-kuunari-bold" style="font-size: 150%; line-height: 100%;">Jim Beam Welcome Sessions with<br /> Lime Cordiale (DJ Set)</div>
                                                <p>Saturday, June 11th</p>
                                                <p>The Rooftop, Sydney</p>
                                                <a href="https://au.rollingstone.com/music/music-pictures/gallery-jim-beam-welcome-sessions-with-lime-cordiale-dj-set-45616/" target="_blank" class="mt-3 btn btn-tickets" target="_blank" class="mt-3 btn btn-tickets">View Gallery</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-flex flex-wrap flex-column flex-md-row align-items-stretch my-3">
                                <div class="col-12">
                                    <div class="mb-4 mb-md-2 mr-0 mr-md-1">
                                        ...
                                        <h2 class="d-flex justify-content-center" style="margin-bottom: 1rem">
                                            <span class="text-kuunari-bold" style="font-size: 175%; line-height: 100%; text-decoration: underline;">LATEST</span>
                                            &nbsp;
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-stretch mb-3">
                                    ...
                                    <div class="col col-md-4 mb-4 pr-0 pr-md-2 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-features/bag-raiders-jim-beam-welcome-sessions-45192/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2020/02/bag-raiders.jpg?resize=1400,700&w=1400">
                                    ...
                                    <div class="col col-md-4 mb-4 pr-0 pr-md-2 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-news/lime-cordiale-jim-beam-welcome-sessions-2-45188/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2020/02/lime-cordiale-1.jpg?resize=1400,700&w=1400">
                                    ...
                                    <div class="col col-md-4 mb-4 pr-0 pr-md-2 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-features/drapht-jim-beam-welcome-sessions-45117/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2023/02/drapht-1.jpg?resize=1400,700&w=1400">
                                    ...
                                    <div class="col col-md-4 mb-4 pr-0 pr-md-2 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-features/jim-beam-welcome-sessions-drapht-44829/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2023/02/drapht-jim-beam.jpg?resize=1400,700&w=1400">
                                    ...
                                    <div class="col col-md-4 mb-4 pr-0 pr-md-2 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-features/lime-cordiale-jim-beam-welcome-sessions-44652/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2023/01/lime-cordiale.jpg?resize=1400,700&w=1400?resize=1400,700&w=1400">
                                    ...
                                    <div class="col col-md-4 mb-4 pr-0 pr-md-2 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-news/lime-cordiale-in-a-one-of-a-kind-music-experience-44530/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2021/04/lc.jpg?resize=900,600&w=1200&w=1200">
                                    ...
                                    <div class="col col-md-4 mb-4 pr-0 pr-md-2 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-news/jim-beam-is-taking-welcome-sessions-to-the-next-level-in-2023-44528/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2023/01/jim-beam.jpg?resize=900,600&w=1200&w=1200">
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-stretch mb-3">
                                    <div class="col-12 col-md-4 mb-4 pr-0 pr-md-2 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-features/jim-beam-welcome-sessions-creates-one-of-a-kind-live-music-experiences-42953/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2022/09/JBWS-local-2022.jpg?resize=900,600&w=1200">
                                    ...
                                    <div class="col-12 col-md-4 mb-4 pr-0 pr-md-2 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-live-reviews/the-veronicas-jim-beam-welcome-sessions-review-42345/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2022/08/Jim-Beam-Welcome-Sessions-Melbourne-3.jpg?resize=900,600&w=1200">
                                    ...
                                    <div class="col-12 col-md-4 mb-4 px-0 px-md-2 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-features/the-veronicas-jim-beam-welcome-sessions-interview-41499/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2022/07/veronicas.jpg?resize=900,600&w=1200?resize=900,600&w=1200">
                                    ...
                                    <div class="col-12 col-md-4 mb-4 pr-0 pr-md-2 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-live-reviews/client-liaison-jim-beam-welcome-sessions-review-41544/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2022/07/Welcome-Sessions-x-Client-Liason-Mitch-Lowe-Photo-1-47.jpg?resize=900,600&w=1200">
                                    ...
                                    <div class="col-12 col-md-4 mb-4 px-0 px-md-2 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-features/client-liaison-interview-jim-beam-welcome-sessions-41480/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2021/08/client-liaison.jpg?resize=900,600&w=1200">
                                    ...
                                    <div class="col-12 col-md-4 mb-4 pr-0 pr-md-2 d-flex align-items-stretch">
                                        <a href="https://tonedeaf.thebrag.com/client-liaison-at-jim-beam-welcome-sessions-brisbane/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/td/uploads/2022/06/client-liaison.jpg?resize=900,600&w=1200">
                                    ...
                                    <div class="col-12 col-md-4 mb-4 pr-0 pr-md-2 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-features/flight-facilities-jim-beam-welcome-sessions-40687/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2021/05/flight-facilities.jpg?resize=900,600&w=1200">
                                    ...
                                    <div class="col-12 col-md-4 mb-4 pl-0 pl-md-2 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/culture/culture-news/jim-beam-welcome-sessions-returns-in-2022-40385/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2021/05/Rolling-stone-jim-beam-welcome-sessions-2022-1.jpg">
                                ...
                                <div class="col-12 col-md-8 d-flex flex-column flex-md-row align-items-stretch my-3">
                                    <div class="col-12 col-md-8 mb-2 px-0 px-md-1 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-features/more-than-just-the-music-how-muse-inspire-unity-among-their-most-dedicated-fans-42377/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2021/08/muse-JBWS-Sam-Grant.jpg">
                                    ...
                                    <div class="col-12 col-md-6 mb-2 px-0 px-md-1 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-features/muse-return-to-the-venue-where-it-all-started-42355/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2022/05/muse-jim-beam-welcome-sessions.jpg">
                                    ...
                                    <div class="col-12 col-md-6 mb-2 px-0 px-md-1 d-flex align-items-stretch">
                                        <div class="news">
                                            <div class="video-placehoder-wrap mb-4 d-flex flex-column">
                                                <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://cdn-r2-2.thebrag.com/pages/jim-beam-2022/images/video-1.1.jpg">
                                    ...
                                    <div class="col-12 col-md-6 mb-2 px-0 px-md-1 d-flex align-items-stretch">
                                        <a href="https://au.rollingstone.com/music/music-features/muse-fosters-community-between-the-lines-of-your-favourite-song-41487/" target="_blank" class="news">
                                            <img src="https://images.thebrag.com/cdn-cgi/image/fit=crop,width=1200,height=628/https://images-r2.thebrag.com/rs/uploads/2022/07/SamGrant_220608_JBWS_Muse_ViennaBerlin_Day3_4643-3-1.jpg">
