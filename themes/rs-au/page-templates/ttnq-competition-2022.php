...
?>
		...
		<div class="competition-prize-sm">
	    	<div class="row mx-3 align-items-start competition-prize-bg">
	     		<div class="col-sm-6 px-0">
	     			<img src="https://cdn.thebrag.com/pages/ttnq-competition-2022/win.png" class="mx-3 mt-3" style="width: 158px; height: 140px;" />
	     		</div>
	     			...
	     			<div style="width: 100%;" class="px-3 py-3">
	     				...
	     				<div class="py-4 px-5 text-center text-uppercase border shadow" style="font-size: 1.125rem; font-weight: 400;">
							<h2 class="competition-sub-heading">
	     					...
	     					<p class="my-3 text-uppercase">
								3 nights accommodation at Crystalbrook Flynn with complimentary breakfast and cocktails at Whiskey & Wine
							</p>
							<p class="my-3 text-uppercase">
	    	...
	    	<div class="mx-3">
     			<div style="width: 100%;" class="px-1 py-1">
	     			...
	     			<div class="px-3 py-0" style="margin-top: -3rem;">
	     				<div class="py-4 px-5 text-center text-uppercase border shadow" style="font-size: 1rem; font-weight: 400; background: #fff;">
							<h2 class="competition-sub-heading">
								Prize Details
							</h2>
			...
			<form id="ttnq-competition-2022-form" method="POST" novalidate>
				<div class="row d-flex px-3">
					<div class="mt-1 pr-1 col-sm-6">
						<label class="text-uppercase">
							First name<br />
							<input type="text" name="firstname" placeholder="Enter your First Name" class="border" value="<?php echo $formdata['firstname']; ?>" required>
						</label>
					</div>
					<div class="mt-1 pl-1 col-sm-6">
						<label class="text-uppercase">
							Last name
							<input type="text" name="lastname" placeholder="Enter your Last Name" class="border" value="<?php echo $formdata['lastname']; ?>" required>
						</label>
					</div>
				</div>
				<div class="row d-flex py-2 px-3">
					<div class="mt-1 pr-1 col-sm-6">
						<label class="text-uppercase">
							Email
							<input type="email" name="email" placeholder="Enter your Email" class="border" value="<?php echo $formdata['email']; ?>" required>
						</label>
					</div>
					<div class="mt-1 pl-1 col-sm-6">
						<label class="text-uppercase">
							Phone Number
							<input type="text" name="phone" placeholder="Enter your Phone Number" class="border" value="<?php echo $formdata['phone']; ?>" required>
						</label>
					</div>
				</div>
				<div class="row py-2 px-3">
					<div class="mt-1 pr-1 col-12">
						<label class="text-uppercase">
							Address
							<div class="my-2">
								<input type="text" name="address1" placeholder="Address 1" class="border" value="<?php echo $formdata['address1']; ?>"  required>
							</div>
							<div class="my-2">
								<input type="text" name="address2"placeholder="Address 2" class="border" value="<?php echo $formdata['address2']; ?>">
							</div>
						</label>
					</div>
				</div>
				<div class="row py-2 px-3">
					<div class="col-sm-6">
						<label class="text-uppercase">
							City
							<input type="text" name="city" placeholder="Enter your City" class="border" value="<?php echo $formdata['city']; ?>" required>
						</label>
					</div>
					<div class="col-sm-3">
                        <?php
						...
						<label class="text-uppercase">
							...
							<select name="state" required>
								...
								<option value="<?php echo $$state; ?>" <?php echo $formdata['state'] == $$state ? 'selected' : ''; ?>><?php echo $$state; ?></option>
								<?php endforeach; ?>
							</select>
						</label>
					</div>
					<div class="col-sm-3">
						<label class="text-uppercase">
							Post Code
							<input type="text" name="postcode" placeholder="Enter your Post Code" class="border"  value="<?php echo $formdata['postcode']; ?>" required>
						</label>
					</div>
				</div>
				<div class="col-12 mt-4 py-2 px-3">
					<div class="d-inline-flex mb-2">
						...
						<span>
							I agree to receive exclusive offers and marketing emails from My Queensland, The Brag and Tourism Tropical North Queensland.
						<span>
					</div>
					<div class="d-inline-flex mb-2">
						<div style="margin-right: 1rem;" class="d-flex align-items-center">
			...
			<table style="font-size: 0.8125rem;">
				<tbody>
					...
					<tr>
						...
						<td>
							Flights to Cairns to the value of $1,980, 3 nights accommodation at Crystalbrook Flynn with complimentary breakfast and cocktails at Whiskey & Winem Reef Magic tour for 2, dinner at Ochre restaurant, 2 nights stay at Cassowary Falls with complimentary breakfast and waterfall tour, Cairns adventure group tours voucher to the value of $300, a Fitzroy island day tour. total prize pool value: $5,500.
						</td>
					</tr>
					<tr>
						<td>
			...
			<table style="font-size: 0.8125rem;">
				<tbody>
					...
					<tr>
						...
						<td>
							No cash redemption. Valid for 2 years Book pending availability / not available on public holidays. Voucher only valid during your stay.
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							Subject to availability. Blackout dates apply: 20 December - 10 January. Advanced booking is essential. Not valid on public holidays or for special events. Please present voucher at time of check-in to redeem your stay. Credit card is required at time of check in. Voucher is not redeemable for cash.
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							Valid for 3 years from the date of purchase. Not redeemable for cash. Resort reservations MUST be contacted at least 72 Hours before this voucher can be used Please quote the voucher when making your reservation and present upon arrival at reception. Voucher must be used in its entirety — residual credit will be forfeited. Bookings are subject to availability. 
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							Not redeemable for cash. Return economy airfares to Cairns for 2 people up to the value of $1800 from Australian airports. Can only be used at Flight Centre Business Travel Cairns. Only 1 voucher can be used per person per booking. Non-transferable. Blackout periods apply – please refer to your experience voucher for further details. Does not apply to travelers cheque transactions. Cannot be used in conjunction with any other offer.
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							• Vouchers are non-refundable, not redeemable for cash, but are transferable. The purchaser must advise Reef Magic Cruises it order to transfer a gift voucher. Failure to show or your scheduled date and time will rerder your voucher invalid. Remember to present your voucher or arrival at check-in as without it, you are unable to participate.<br />
							• Treat your voucher like cash and take care not to lose it. Lost or stolen vouchers are nor-refundable and no replacements are available.<br /> 
							• Any add-ors, optional activities or extras will be payable in additior to this voucher. The voucher holder will also be required to Day any price differences between the voucher value and current prices on the day of travel. All bookings are subject to availability and operator discretion. <br />
							• Standard Reef Magic Cruises booking terms and conditions apply and can be viewed at https://www.reefmagic.com 
						</td>
					</tr>
					<tr>
						<td>
	...
	<?php if($success) : ?>
		<div class="modal focus" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" style="display: block; z-index: 999999;">
			<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
				<div class="modal-content competition-success px-3 py-5 rounded-0" style="max-width: 542px;">
					<a href="https://www.myqldholiday.com.au/" target="_blank">
						<img src="https://cdn.thebrag.com/pages/ttnq-competition-2022/success-banner.jpg" style="width: 100%;" />
					</a>
					...
					<div class="competition-success-message text-center pt-2">
						<a href="https://www.myqldholiday.com.au/" target="_blank">
							<img src="https://cdn.thebrag.com/pages/ttnq-competition-2022/success-cta.jpg" style="max-width: 425px; width: 100%;" />
						</a>
					</div>
...
<?php else : ?>
	...
	<div class="l-page__content d-flex align-items-center justify-content-center mx-auto text-center" style="max-width: 1000px; min-height: 1000px; background: #fff;">
			<?php echo get_the_password_form(); ?>
	</div>
<?php 
	endif; endwhile; // Password protected
	wp_reset_query();
	endif;
