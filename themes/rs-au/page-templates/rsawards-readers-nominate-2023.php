...
/**
 * Template Name: RS Awards Readers Nomimate (2023)
 */
...
$noms_open_at = '2023-02-06 12:00:00';
...
if (is_user_logged_in()) :
	...
	require_once get_template_directory() . '/page-templates/rs-awards/2023/submit.php';
	...
	wp_enqueue_script('rs-awards-23', get_template_directory_uri() . '/page-templates/rs-awards/js/scripts-2023.js', array('jquery'), time(), true);
endif; // If logged in
					...
					<div class="col-12">
						...
						?>
							...
							?>
								...
								if (current_user_can('administrator')  || $subscriptions || $current_user->ID == 1338) : // If subscriptions
								?>
									<div style="font-family: 'Roboto', sans-serif;">
										<h2 style="text-align: center; margin: 1rem auto 2rem auto; color: #000;">Nominate Your Favourite Artist</h2>
										...
										<p>As a Rolling Stone Australia subscriber, you are part of an elite club that pays for music journalism. This means music really matters to you, and it is for that reason you are a vital part of the 2023 Shure Rolling Stone Australia Awards.</p>
										...
										<p>From today until 12th March, Rolling Stone Australia subscribers can cast their nomination for their favourite Australian artist.</p>
										<p>From there, the most nominated artists will progress to a final round where subscribers will vote for the final winner.</p>
										...
										<p>Any Australian artist who has released a song, album or EP within the eligibility period of November 1st, 2021, to October 15th, 2022 is eligible, and can be nominated below.</p>
										<p>You will decide the winner of the prestigious and most coveted Rolling Stone Australia Readers Award.</p>
									</div>
									<div class="flex-wrap">
										<?php
										// delete_user_meta($current_user->ID, 'rsawards_nominated_2023');
										...
										<?php else :  ?>
											...
											<div id="awardnoms1" class="awardnoms card" aria-labelledby="awardnoms-heading1" data-id="1" style="">
												<div class="card-body bg-dark text-white">
													<p>
														For your nomination to count the artist <strong>must be an Australian resident or citizen</strong> and must have released an Album, EP or single between <strong>November 1st, 2021, to October 15th, 2022</strong>.
													</p>
									...
									<div class="t-c-wrap">
										<table style="font-family: 'Roboto', sans-serif;">
											<tbody>
												...
												<tr>
													<td>Entry Period</td>
													<td>Starts at 12:00 hours AEDT on 6 February 2021 and ends at 23:59 hours AEDT on 12 March 2023</span></td>
												</tr>
												<tr>
													<td>Entry</td>
													<td>
														(a) Go to https://au.rollingstone.com/nominate-for-rolling-stone-australia-readers-award-2023/ (“Website”); <br />
												...
												<tr>
													...
													<td>23:59 hours AEDT on 12th March 2023 at The Brag Media.</td>
												</tr>
												<tr>
													<td>Notification</td>
													<td>By email by 15th March 2022</td>
												</tr>
												<tr>
													<td>Claim Period</td>
		...
		jQuery(document).ready(function($) {
			jQuery(document).ready(function($) {
				$('#voting-form').on('submit', function(eve) {
					...
					formData.append('action', 'nominate_readers_award_2023');
