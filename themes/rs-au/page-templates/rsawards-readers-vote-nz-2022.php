...
/**
 * Template Name: RS Awards Readers Vote NZ (2022)
 */
          ...
          <div class="col-12">
            ...
            ?>
              ...
              if (is_user_logged_in()) :
                ...
                $my_vote_artist_id = $wpdb->get_var($wpdb->prepare("SELECT artist_id FROM {$wpdb->prefix}rsawards_votes_final_nz_2022 WHERE user_id = %d", $current_user->ID));
              ?>
                ...
                ?>
                  <div style="font-family: 'Roboto', sans-serif;">
                    <p>As a Rolling Stone subscriber, you are part of an elite club that pays for music journalism. This means music really matters to you, and it is for that reason you are a vital part of the 2022 Panhead Rolling Stone New Zealand Awards.</p>
                    ...
                    <p>From today until July 24, Rolling Stone Australia/New Zealand subscribers can cast their vote for their favourite New Zealand artist by voting for the Rolling Stone Reader's Award.</p>
                  ...
                  <div class="row flex-wrap" id="list-artists">
                    <?php
                    $artists = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}rsawards_artists_nz_2022 ORDER BY artist_name ASC");
                    if ($artists) :
  ...
  <script>
    ...
    jQuery(document).ready(function($) {
      ...
      $('input[name="artist"]').on('change', function() {
        ...
        formData.append('action', 'vote_readers_award_nz_2022');
