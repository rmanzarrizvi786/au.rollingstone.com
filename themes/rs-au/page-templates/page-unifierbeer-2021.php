...
/**
 * Template Name: Unifier Beer Microsite (2021)
 */

get_template_part('page-templates/unifierbeer-2021/header');

wp_enqueue_script('unifierbeer-2021', RS_THEME_URL . '/page-templates/unifierbeer-2021/js/scripts.js', ['jquery'], time(), true);
// wp_enqueue_script('skrollr', RS_THEME_URL . '/page-templates/unifierbeer-2021/js/skrollr.min.js', [], null, true);
// wp_enqueue_script('skrollr-menu', RS_THEME_URL . '/page-templates/unifierbeer-2021/js/skrollr.menu.min.js', [], null, true);
              ...
              <figure class="c-picture2" style="margin: auto;">
                <div class="c-picture__frame2">
                  ...
                  <div class="c-crop2 c-crop--ratio-3x2-2 logo">
                    <img src="<?php echo RS_THEME_URL; ?>/page-templates/unifierbeer-2021/images/Asset1.svg" style="width: 35%; max-width: 100%;">
                  </div><!-- .c-crop -->
                </div>
      ...
      <?php if ($live) : ?>
        <div class="decades">
          ...
          for ($i = 1, $decade = 1960; $decade <= 2020; $i++, $decade += 10) :
            include CHILD_THEME_PATH . '/page-templates/unifierbeer-2021/decades/' . $decade . '.php';
          endfor;

          include CHILD_THEME_PATH . '/page-templates/unifierbeer-2021/decades/protest-music.php';

          include CHILD_THEME_PATH . '/page-templates/unifierbeer-2021/decades/charities.php';
          ?>
        </div>
