...
/**
 * Template Name: 50 Greatest Artists 2021
 */
      ...
      <div class="l-page__content">
        ...
        <div class="l-section l-section--no-separator" style="margin: 2rem auto; max-width: 65rem;">
          ...
          <article class="top-list-wrap" data-id="<?php echo get_the_ID(); ?>" data-premium="true">
              ...
              <h1 data-href="<?php the_permalink(); ?>" style="line-height: 2.5rem;"><?php the_title(); ?></h1>
              ...
              <div class="c-list c-list--albums">
                ...
                ?>
                    ...
                    $query = "SELECT * FROM {$wpdb->prefix}greatest_artists_2021 WHERE position <= {$start} AND position > {$to} ORDER BY position DESC ";
                    // echo $query;
                    $artists = $wpdb->get_results($query);

                    if ($artists) :
                      foreach ($artists as $artist) : ?>
                        <article class="c-list__item" id="list-item-<?php echo $artist->position; ?>" data-list-item="<?php echo $artist->position; ?>" data-list-title="Artist at <?php echo $artist->position; ?>" data-list-permalink="<?php echo get_permalink(); ?>page/<?php echo $paged; ?>/<?php echo $artist->slug; ?>/" data-list-item-id="<?php echo $artist->position; ?>" data-href="<?php echo get_permalink(); ?>page/<?php echo $paged; ?>/<?php echo $artist->slug; ?>/">
                          <div class="list-content">
                            ...
                            <header class="c-list__header">
                              ...
                              <h3 class="c-list__title t-bold" style="margin-bottom: 1rem;"><?php echo stripslashes($artist->title); ?></h3><!-- /.c-list__title -->
                          ...
                          <div class="author-content">
                            <div class="author-wrap">
                              <?php if (!is_null($artist->author_image_url) && '' != trim($artist->author_image_url)) : ?>
                                ...
                                <header class="c-list__header">
                                  <h4 class="c-list__title t-bold">By <?php echo stripslashes($artist->author); ?></h4><!-- /.c-list__title -->
