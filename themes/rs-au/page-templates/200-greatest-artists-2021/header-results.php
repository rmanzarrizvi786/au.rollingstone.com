...
<head>
  ...
  <style>
    ...
    .logo-wrap {
      background-image: url(<?php echo RS_THEME_URL; ?>/images/goat-2021/Cover-Art_RGB_background.jpg);
    ...
    input[type=password],
    .top-list-wrap input[type=text],
    .top-list-wrap input[type=email],
    .top-list-wrap textarea {
    ...
    .top-list-wrap article {
      display: flex;
    }

    .top-list-wrap article img {
      max-width: 100%;
      height: auto;
    }

    .top-list-wrap article .list-content {
      flex: 0 0 70%;
      max-width: 70%;
      padding-right: 1rem;
    }

    .top-list-wrap article .author-content {
      flex: 0 0 30%;
      max-width: 30%;
      padding-left: 1rem;
    }

    .top-list-wrap article .author-content .author-wrap {
      position: sticky;
      top: 50px;
    }
...
<body data-list-page data-list-total="200" <?php body_class('pmc_list-template-default single single-pmc_list'); ?>>
