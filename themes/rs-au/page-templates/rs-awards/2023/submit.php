<?php
$date_from = date('Y-m-d', strtotime('2 Mar 2023'));
$date_to = date('Y-m-d', strtotime('9 Mar 2023'));
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (count($errors) === 0) {
    ...
    if (isset($_POST['action']) && 'edit' == $_POST['action']) {
      $wpdb->delete(
        $wpdb->prefix . 'rsawards_nominations_2023',
        [
    ...
    // if ('add' == $_POST['action'] && $success && (!isset($rs_nominated) || $rs_nominated != true)) 
    {
      ...
      */
      ...
      add_user_meta($current_user->ID, 'rsawards_nominated_2023', true);
    }
