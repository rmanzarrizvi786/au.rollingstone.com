...
<?php if ($noms_open) : ?>
    <?php if (isset($context) && 'nominate' == $context) : ?>
        <div class="text-center mt-5 mb-3">
            ...
            <p>
                <a href="https://theindustryobserver.thebrag.com/nominate-for-rolling-stone-awards-2022/nz?a=add" target="_blank" class="p-2 btn-nominate">
...
<div class="rsa-content my-2">
    ...
    <p class="text-center" style="font-size: 125%;">You will decide the nominations of the Sailor Jerry Rolling Stone New Zealand Awards.</p>
...
<?php if (isset($context) && 'info' == $context) : ?>
