                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="mcnImageContent" valign="top" style="padding-right: 0px; padding-left: 0px; padding-top: 0px; padding-bottom: 0px; text-align:center; background: #ffffff;">
                                                                ...
                                                                <img align="center" alt="Nomination confirmed for Sailor Jerry Rolling Stone Australia Awards" src="https://images-r2.thebrag.com/rs/uploads/2020/11/VOTED_600x1200px_200kb.jpg?cache=1" width="<?php echo $container_width; ?>" style="width: <?php echo $container_width; ?>px; height: auto; max-width: 100%; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top: 0px; padding-bottom: 30px; text-align: center;">
                                                                ...
                                                                $bm_social_links = array(
                                                                    'facebook' => 'https://www.facebook.com/theindustryobserver',
                                                                    'twitter' => 'https://twitter.com/theindustry_o',
                                                                    'instagram' => 'https://www.instagram.com/theindustryobserver/',
