...
/**
 * Class Social_Small_Nav_Walker
 *
 * @since 2018-04-13
 */
class Social_Small_Nav_Walker extends \Rolling_Stone\Inc\Menus\Social_Nav_Walker {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$output .= sprintf(
			'<li class="c-social-bar__item"><a href="%s" class="c-social-bar__link" title="%s" rel="noopener noreferrer"%s><span class="c-icon c-icon--white"><svg><use xlink:href="#svg-icon-%s"></use></svg></span><span class="screen-reader-text">%s</span></a>',
			esc_url( $item->url ),
			esc_attr( $item->title ),
			$target,
			esc_attr( $icon ),
