...
<head>
	...
	<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/images/jim-beam-2022/Kuunari-CondensedLetterpress.otf" as="font">
	<link rel="preload" href="<?php echo get_template_directory_uri(); ?>/images/jim-beam-2022/Kuunari-BoldLetterpress.otf" as="font">

	<style>
		@font-face {
			font-family: 'Kuunari-CondensedLetterpress';
			src: url('<?php echo get_template_directory_uri(); ?>/images/jim-beam-2022/Kuunari-CondensedLetterpress.otf') format('opentype');
			font-weight: normal;
			font-style: normal;
			font-display: block;
		}
		...
		@font-face {
			font-family: 'Kuunari-BoldLetterpress';
			src: url('<?php echo get_template_directory_uri(); ?>/images/jim-beam-2022/Kuunari-BoldLetterpress.otf') format('opentype');
			font-weight: normal;
			font-style: normal;
			font-display: block;
		}
		...
		@font-face {
			...
			src: url('<?php echo get_template_directory_uri(); ?>/images/jim-beam-2022/Americana Std Extra Bold.otf') format('opentype');
			font-weight: normal;
			font-style: normal;
			font-display: block;
		}
		...
		@font-face {
			font-family: 'PublicoBanner-Ultra';
			src: url('<?php echo get_template_directory_uri(); ?>/images/jim-beam-2022/PublicoBanner-Ultra.otf') format('opentype');
			font-weight: normal;
			font-style: normal;
			font-display: block;
		}
		...
		@font-face {
			...
			src: url('<?php echo get_template_directory_uri(); ?>/images/jim-beam-2022/Graphik-Medium.otf') format('opentype');
			font-weight: normal;
			font-style: normal;
			font-display: block;
		}
		...
		.intro {
			...
			background-image: url(<?php echo get_template_directory_uri(); ?>/images/jim-beam-2022/crowd.jpg);
			position: relative;
		...
		.about .content-wrap {
			/* background-color: rgb(227, 175, 62); */
			/* color: #fff; */
			font-size: 170%;
			line-height: 150%;
			font-family: Graphik-Medium, sans-serif;
		...
		.shows {
			...
			background-image: url(<?php echo get_template_directory_uri(); ?>/images/jim-beam-2022/free-black-paper-texture.jpg);
		}
		...
		@media (min-width: 48rem) {
			...
			/* .event.event-brisbane,
			.event.event-melbourne {
				height: 270px;
				overflow: hidden;
			} */
		}
