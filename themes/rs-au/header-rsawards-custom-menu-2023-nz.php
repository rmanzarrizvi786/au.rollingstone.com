...
<head>
    ...
    background: linear-gradient(-45deg, #d32531 50%, rgba(211, 37, 49, 0.5) 50%); */
		...
		@font-face {
			...
			src: url("<?php echo get_template_directory_uri(); ?>/assets/build/fonts/Graphik/GraphikXCondensed-BoldItalic.otf") format("opentype");
			font-display: block;
		}
...
&noscript=1" />
		...
		<div class="l-page" id="site_wrap" style="width: 100%; max-width: 100%; overflow-x: hidden">
			<?php get_template_part('template-parts/header/header', 'rsawards-2023-nz'); ?>