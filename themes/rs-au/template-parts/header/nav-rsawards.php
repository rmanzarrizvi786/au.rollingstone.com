...
<nav class="l-header__nav" style="order: 2;">
	...
	$menu_items = [
		'news' => [
			'title' => 'News',
			'link' => home_url('rolling-stone-awards-2022?show=news')
		],
		'info' => [
			'title' => 'Info',
			'link' => home_url('rolling-stone-awards-2022?show=info')
		],
		'categories' => [
			'title' => 'Award categories',
			'link' => home_url('rolling-stone-awards-2022?show=categories')
		],
		/* 
		'venue-details' => [
			'title' => 'Venue Details',
