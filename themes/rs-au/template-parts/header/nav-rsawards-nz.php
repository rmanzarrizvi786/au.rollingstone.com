...
<nav class="l-header__nav" style="order: 2;">
	...
	$menu_items = [
		'news' => [
			'title' => 'News',
			'link' => home_url('rolling-stone-awards-2022/nz/?show=news')
		],
		'info' => [
			'title' => 'Info',
			'link' => home_url('rolling-stone-awards-2022/nz/?show=info')
		],
		// 'categories' => [
		// 	'title' => 'Award categories',
		// 	'link' => home_url('rolling-stone-awards-2022/nz/?show=categories')
		// ],
		/* 'judges' => [
			'title' => 'Judges',
		...
		[
			...
			'link' => home_url('/nominate-for-rolling-stone-new-zealand-readers-award-2022/'),
			'target' => '_blank',
		], */
	];
	?>
