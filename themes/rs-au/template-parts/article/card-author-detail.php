...
<div class="c-author">
	...
	<div class="c-author__meta">
		...
		<?php if (!empty($author->_pmc_title)): ?>
			<p class="c-author__role">
				<?php echo esc_html($author->_pmc_title); ?>
			</p>
		<?php endif; ?>
		...
		if (!empty($author->_pmc_user_twitter)):
			...
			?>
			<a class="c-author__twitter t-bold" href="<?php echo esc_url($twitter_link); ?>" target="_blank"
			...
			<a href="<?php echo esc_url($twitter_link); ?>" class="c-btn c-btn--block c-btn--twitter t-bold t-bold--upper"
	...
	<h4 class="c-author__heading t-bold">
		<?php echo esc_html($author->display_name); ?>'s
		<?php esc_html_e('Most Recent Stories', 'pmc-rollingstone'); ?>
	</h4>
