<div class="l-footer__tip">
	<p class="l-footer__tip-heading t-bold"><?php esc_html_e('Have you got Tip/Op-Ed/Video?', 'pmc-rollingstone'); ?></p>
	<div class="l-footer__tip-body">
		<?php // esc_html_e( 'We want to hear from you!.', 'pmc-rollingstone' ); 
		?>
	</div>
	...
	<img class="l-footer__logo" src="<?php echo RS_THEME_URL . '/assets/src/images/_dev/RSAUwhitewhite_WEB.png'; ?>">
</div><!-- .l-footer__tip -->