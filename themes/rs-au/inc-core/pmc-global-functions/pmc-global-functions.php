...
require PMC_GLOBAL_FUNCTIONS_PATH . '/classes/class-pmc-crypto.php';
...
function pmc_maybe_minify_url( $path = '', $plugin = '' ) {
	// disable the minify code for debug for now
...
//This function loads global plugins thats required on all sites. Please dont move its position.
